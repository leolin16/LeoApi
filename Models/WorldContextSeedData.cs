...
namespace LeoPortal2.Models
{
    ...
    {
        //private WorldUser newUser;
        //private IConfigurationRoot _config;
        private WorldContext _context;
        //private UserManager<WorldUser> _userManager;

        //public WorldContextSeedData(WorldContext context, UserManager<WorldUser> userManager, IConfigurationRoot config)
        ...
        //public void EnsureSeedDataAsync()
        {
            ...
            //{
            //    // Add the User.
            //    newUser = new WorldUser()
            //    {
            //        UserName = "leolin",
            //        Email = "leolin@LeoPortal2.studio"
            //    };
            ...
            if (!_context.Favlinks.Any())
            {
                // Add New Data
                var webpageFavlink = new Favlink()
                {
                    TitleLevel1 = "Electronic",
                    TitleLevel2 = "IT",
                    TitleLevel3 = "Web",
                    TitleLevel4 = "Hosting",
                    Name = "Domain",
                    ...
                    Links = new List<Link>()
                    {
                        new Link() { TitleLevel1 = "Website", TitleLevel2 = "Oversea", TitleLevel3 = "Personal", TitleLevel4 = "Leo Lin", Name = "LeoPortal2.studio", URL = "https://LeoPortal2.studio/", Order = 0 },
                        new Link() { TitleLevel1 = "Website", TitleLevel2 = "Oversea", TitleLevel3 = "Personal", TitleLevel4 = "Leo Lin", Name = "muses.live", URL = "https://muses.live/", Order = 1 },

                    }
                };

                _context.Favlinks.Add(webpageFavlink);
                _context.Links.AddRange(webpageFavlink.Links);

                await _context.SaveChangesAsync();
            }
            if (!_context.Cashflows.Any())
            {
                // Add New Data
                var demoCashflow = new Cashflow()
                {
                    TitleLevel1 = "Electronic",
                    TitleLevel2 = "IT",
                    TitleLevel3 = "Web",
                    ...
                    {
                        new Cashitem() { TransactionDate = new DateTime(2012,3,30,12,31,28,DateTimeKind.Local), FlowDirection = "In", FromParty = "Cognizant", ToParty = "Leo Lin", MoneyAmount = 2000.11, MoneyUnit = "元", MoneyDescription = "went in cash amount" },
                        new Cashitem() { TransactionDate = new DateTime(2012,3,31,11,34,51,DateTimeKind.Local), FlowDirection = "Out", FromParty = "Leo Lin", ToParty = "Parents", MoneyAmount = 123.45, MoneyUnit = "元", MoneyDescription = "went out cash amount" },

                    }
                };

                _context.Cashflows.Add(demoCashflow);
                _context.Cashitems.AddRange(demoCashflow.Cashitems);
